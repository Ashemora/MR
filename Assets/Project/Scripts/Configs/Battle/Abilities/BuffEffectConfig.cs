...
namespace Project.Scripts.Configs.Battle.Abilities
{
    ...
    public class BuffEffectConfig
    {
        ...
        [Tooltip("Когда баф снимается: Battle = до конца боя, NextAttack = после следующей атаки цели, NextActivation = после следующей активации цели, UntilEndOfNextMainPhase = до конца следующей Match/Hero фазы, UntilEndOfRound = до конца текущего раунда")]
